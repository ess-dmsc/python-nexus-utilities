...
if __name__ == '__main__':
    ...
    optional_args.add_argument('-p', '--plot', action='store_true', default=False, help='Plots the geometry in the DetectorPlotter')
    optional_args.add_argument('-d', '--outputdirectory', default=None, help='The output directory where the generated nexus file should go')
    optional_args.add_argument('-f', '--outputfilename', default=None, help='The filename desired for the generated nexus file')
    ...
    output_dir = arguments.outputdirectory if arguments.outputdirectory else os.path.dirname(os.path.realpath(arguments.IDF))
    output_filename = arguments.outputfilename if arguments.outputfilename else os.path.splitext(os.path.basename(arguments.IDF))[0] + '.hdf5'
