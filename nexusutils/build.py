...
if __name__ == '__main__':
    ...
    optional_args.add_argument('-d', '--output-directory', default=None,
                               help='The output directory where the generated NeXus file should go')
    optional_args.add_argument('-f', '--output-filename', default=None,
                               help='The filename desired for the generated NeXus file')
    optional_args.add_argument('-o', '--off-filename', default=None,
